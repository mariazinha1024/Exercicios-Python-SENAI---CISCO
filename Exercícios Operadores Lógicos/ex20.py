...
inss = float(input("Quanto é o % descontado de INSS do seu salário? "))
ir = float(input("Quanto é o % descontado de Imposto de Renda do seu salário? "))
bonificacao = float(input("Quanto de bonificação você recebe? "))

inssper = salario * inss/100
irper = salario*ir/100

total = salario-inssper-irper+bonificacao
